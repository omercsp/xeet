...
class TestCore(XeetUnittest):
    ...
    def test_simple_test(self):
        ...
        expected = TestResult(status=TestStatus.NotRun, sub_status=TestSubStatus.TestErr,
    ...
    def test_step_lists(self):
        ...
        expected = TestResult(status=TestStatus.NotRun, sub_status=TestSubStatus.PreTestErr,
    ...
    def test_skipped_tests(self):
        ...
        expected.status = TestStatus.NotRun
        expected.sub_status = TestSubStatus.PreTestErr
    ...
    def test_expected_failure(self):
        ...
        expected.status = TestStatus.Failed
        expected.sub_status = TestSubStatus.Undefined
