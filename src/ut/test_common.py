...
def test_xeet_vars_simple():
    ...
    assert xvars.expand(ref_str("d1")) == {"a": 1, "b": 5, "c": ["a", "value1", 5]}
    assert xvars.expand(ref_str("d1.b")) == 5
    assert xvars.expand(ref_str("d1.c")) == ["a", "value1", 5]
    assert xvars.expand(ref_str("d1.c.[1]")) == "value1"
...
def test_xeet_vars_string_literals():
    ...
    assert xvars.expand(r"_\{var1}{var2}") == \
           r"_{var1}value1 value2"
    ...
    xvars = XeetVars({
        "var1": "value1",
        "var2": {"key1": "inner1", "key2": "inner2"},
    })

    assert xvars.expand("{var2.key1}") == "inner1"
    assert xvars.expand("{var1} {var2.key2}") == "value1 inner2"
    assert xvars.expand("{var1} {var2}") == "value1 {'key1': 'inner1', 'key2': 'inner2'}"
