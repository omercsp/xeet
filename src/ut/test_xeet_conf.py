...
from xeet.core.xeet_conf import (XeetModel, TestsCriteria, XeetIncludeLoopException, _XeetConf,
                                 xeet_conf, clear_drivers_cache, BaseXeetSettings)
...
class TestXeetConf(XeetUnittest):
    ...
    def test_inclusion_loop(self):
        ...
        conf0.save()
        self.assertRaises(XeetIncludeLoopException, xeet_conf, BaseXeetSettings(conf0.file_path))

        conf1 = ConfigTestWrapper(CONF1, includes=[conf0.file_path])
        conf1.save()
        self.assertRaises(XeetIncludeLoopException, xeet_conf, BaseXeetSettings(conf1.file_path))
        ...
        conf2.save()
        self.assertRaises(XeetIncludeLoopException, xeet_conf, BaseXeetSettings(conf2.file_path))
