...
class TestConfig(DummyTestConfig):
    ...
    def test_get_xtest_by_group(self):
        ...
        self.add_test(_TEST0, groups=[GROUP0], reset=True)
        self.add_test(_TEST1, groups=[GROUP1])
        self.add_test(_TEST2, groups=[GROUP2])
        self.add_test(_TEST3, groups=[GROUP0, GROUP1], save=True)
    ...
    def test_get_all_tests(self):
        ...
        xeet = self.driver()
        xtests = xeet.xtests(criteria=_ALL_TESTS_CRIT)
    ...
    def test_misc_test_filteing(self):
        self.add_test(_TEST0, reset=True)
        self.add_test(_TEST1, groups=["group0"])
        self.add_test(_TEST2, groups=["group1"])
        self.add_test(_TEST3, groups=["group0", "group1"], save=True)
        ...
        xtests = xeet.xtests(TestCriteria(include_groups=["group1"], names=[_TEST0]))
        self.assertEqual(len(xtests), 3)
    ...
    def test_get_groups(self):
        self.add_test(_TEST0, groups=["group0"], reset=True)
        self.add_test(_TEST1, groups=["group1"])
        self.add_test(_TEST2, groups=["group2"], save=True)
