...
from xeet.core.xres import TestStatus
...
class TestExecStep(XeetUnittest):
    ...
    def test_simple_exec(self):
        ...
        expected = gen_exec_result(TestStatus.RunErr, rc=None, os_error=OSError(),
                                   completed=False)
    ...
    def test_timeout(self):
        ...
        self.add_test(TEST0, run=[step_desc], reset=True, save=True)
        expected = gen_exec_result(TestStatus.RunErr, completed=False, timeout_period=True)
        self.assertTestResultEqual(self.run_test(TEST0), expected)
    ...
    def test_output_behavior(self):
        ...
        expected = gen_exec_result(TestStatus.Failed, rc=0, rc_ok=True, completed=True,
