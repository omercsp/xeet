...
from xeet.core.xeet_conf import _XeetConf, xeet_conf, clear_drivers_cache
...
class XeetUnittest(unittest.TestCase):
    ...
    @classmethod
    def driver(cls) -> _XeetConf:
        return xeet_conf(BaseXeetSettings(file_path=cls.main_config_wrapper.file_path))
