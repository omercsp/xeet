...
from xeet.common import XeetVars, platform_path
...
from xeet.core import RunReporter
...
class XeetUnittest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.reporter = RunReporter(iterations=1)
    ...
    def run_test(cls, name: str) -> TestResult:
        ...
        run_result = run_tests(cls.main_config_wrapper.file_path, cls.criteria, cls.reporter)
