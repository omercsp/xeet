...
from xeet.core.xtest import TestResult, TestStatus
...
class TestCore(XeetUnittest):
    def test_basic_thread_support(self):
    ...
    def test_get_resource_by_name(self):
        ...
        expected = TestResult(status=TestStatus.RunErr, sub_status=TestSubStatus.InitErr)
    ...
    def test_randomized_resource_race(self):
        ...
        for i in range(N):
            ...
            sleep_time = round(random.randint(1, 5) * 0.1, 1)
