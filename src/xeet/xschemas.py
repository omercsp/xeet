...
class XTestKeys(object):
    ...
    CompareOutputFile = "compare_output_file"
...
XTEST_SCHEMA = {
    ...
    "properties": {
        ...
        XTestKeys.CompareOutput: {"type": "boolean"},
        XTestKeys.CompareOutputFile: {"type": "string", "minLength": 1},
        ...
        XTestKeys.OutputBehavior: {
            "enum": [
                OutputBehaviorValues.OutOnly,
                OutputBehaviorValues.ErrOnly,
                OutputBehaviorValues.Unify,
                OutputBehaviorValues.Split,
                OutputBehaviorValues.NoOutput
            ]
        },
