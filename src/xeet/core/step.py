...
class Step:
    ...
    def notify(self, *args, **kwargs) -> None:
        self.rti.notifier.on_step_message(*args, step=self, **kwargs)

    def warn(self, *args, **kwargs) -> None:
        self.rti.notifier.on_step_message(*args, step=self, severity=logging.WARN, **kwargs)

    def error(self, *args, **kwargs) -> None:
        self.rti.notifier.on_step_message(*args, step=self, severity=logging.ERROR, **kwargs)

    def debug(self, *args, **kwargs) -> None:
        self.rti.notifier.on_step_message(*args, step=self, dbg_pr=True, **kwargs)
    ...
    def run(self) -> StepResult:
        ...
        self.notify(f"step finished in {res.duration:.3f}s", dbg_pr=False)
        return res
