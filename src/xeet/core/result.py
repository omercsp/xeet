...
class TestResult:
    ...
    duration: float = 0
    status_reason: str = ""
    pre_run_res: PhaseResult = field(default_factory=lambda: PhaseResult(name="Pre-run"))
    run_res: PhaseResult = field(default_factory=lambda: PhaseResult(name="Run"))
    post_run_res: PhaseResult = field(default_factory=lambda: PhaseResult(name="Post-run"))
