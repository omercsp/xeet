...
class CliPrinter(EventReporter):
    ...
    def on_iteration_start(self) -> None:
        ...
        if self.iterations == 1:
            return
        pr_info(colorize_str(self._iter_header(self.iteration_index, False), _ITERATION_COLOR))
    ...
    def on_run_end(self) -> None:
        ...
        for iter_i, iter_res in enumerate(self.run_res.iter_results):
            ...
            if self.concise:
                continue
            header = self._iter_header(iter_i, True)
