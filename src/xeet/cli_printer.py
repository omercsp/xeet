...
class DebugPrinter(CliPrinter):
    ...
    def on_test_enter(self, test: Test) -> None:
    ...
    def on_step_start(self, test: Test | None = None, phase_name: str = "",
                      step: Step | None = None, step_index: int = -1, **_) -> None:
        assert test is not None
    ...
    def on_step_end(self, phase_name: str = "", step: Step | None = None, step_index: int = -1,
                    step_res: StepResult | None = None, **_) -> None:
        assert step is not None
