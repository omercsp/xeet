from xeet.common import XeetVars, text_file_tail
from xeet.log import log_raw, log_error, log_warn
from xeet.pr import pr_info
from xeet.xstep import XStep, XStepModel, XStepResult, XStepTestArgs, XeetStepException
...
class ExecStep(XStep):
    ...
    def _run(self, res: ExecStepResult) -> None:  # type: ignore
        subproc_args: dict = {
            "env": self.env,
