...
def parse_arguments() -> argparse.Namespace:
    ...
    test_filter_parser.add_argument('-t', '--test', metavar='TESTS', default=[],
                                    type=_tokens_list_type_checker, help='test name', dest='tests')
    ...
    run_parser.add_argument('--full-timing', action='store_const',
                            default=False, help='show full test timing')
    ...
    if args.subparsers_name == _INFO_CMD:
        args.all = True
...
def _display_settings(args: argparse.Namespace) -> BaseConsoleReporterOpts:
    if args.debug:
