...
def parse_arguments() -> argparse.Namespace:
    ...
    run_parser.add_argument('--summary-timings', action=argparse.BooleanOptionalAction,
                            help='show summary timings', default=True)
    ...
    try:
        ...
        if cmd_name == _RUN_CMD:
            return actions.run_tests(args.conf, args.repeat, args.debug,
                                     ...
                                     args.summary_opt, args.test_timing, args.summary_timings)
