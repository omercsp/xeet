...
def parse_arguments() -> argparse.Namespace:
    ...
    run_parser.add_argument('--show-summary', action=argparse.BooleanOptionalAction,
                            help='summary type', default=True)
    run_parser.add_argument('--show-iter-summary', action=argparse.BooleanOptionalAction,
                            help='summary type for each iteration', default=False)
    run_parser.add_argument('--show-summary-details', action=argparse.BooleanOptionalAction,
                            help='show extra summary details where applicable', default=False)
    run_parser.add_argument('--show-ongoing', action=argparse.BooleanOptionalAction,
                            help='summary ongoing tests status line', default=True)
...
def _display_settings(args: argparse.Namespace) -> CliPrinterShowOpts:
    opts = CliPrinterShowOpts(
        ...
        test_timing_opt=args.test_timing,
        thread_count=args.show_thread_count,
        jobs=args.jobs,
        summary=args.show_summary,
        iter_summary=args.show_iter_summary,
        detailed_summary=args.show_summary_details,
        ongoing=args.show_ongoing)
