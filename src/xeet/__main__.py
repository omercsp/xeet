...
def parse_arguments() -> argparse.Namespace:
    ...
    run_parser.add_argument('-t', '--test', metavar='TEST', default=[], help='test name',
                            action='append')
...
def xrun() -> int:
    ...
    try:
        ...
        if cmd_name == _RUN_CMD:
            run_info = actions.run_tests(args.conf, args.test, args.group, args.require_group,
                                         args.exclude_group, args.repeat, args.show_summary,
                                         args.debug)
            ...
            actions.list_tests(args.conf, args.names_only, args.group, args.require_group,
                               args.exclude_group, args.all)
