...
def title(title: str, underline_char='=', newline_prefix: bool = True, color: str = XColors.Bold,
          ) -> str:
    if color != XColors.NoColor:
        title = colorize_str(title, color)
    text = Text.from_markup(title)
